...
<link href="StyleSheet.css" rel="stylesheet">
        ...
        <link href="StyleSheet.css" rel="stylesheet">
        <title>SocialOwl - <?php echo $username?></title>
  ...
  background:#75B7ED; 
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <div class="profile" style=" width:auto;overflow:hidden;background-color:white;margin-left:10%;margin-right:10%;margin-top:4rem;border-radius:8px;margin-bottom:2rem;word-wrap: break-word;">
    ...
    <div class="col">
            ...
            <div class="info-div" style="float:left;margin-top:4%;width:17rem;word-wrap: break-word;margin-left:2rem;"> 
                ...
                <p><a href="EditDetails.php" style="color:black"><strong>Edit Profile</strong></a></p>
            </div>
            </div>
        </div>
                </div>
            ...
            <div class="row">
            <div  class="col" style="background-color:#F7F7F7;margin-top:2rem;margin-left:2%;margin-right:2%;padding:2rem;overflow:hidden">
                <div style="width:50rem">
                <span style="font-size:30px;float:left;margin-bottom:3rem">My Posts:</span>
                </div>
                ...
                $qp = "SELECT * FROM posts WHERE user_id =".$eg." ORDER BY date DESC";
                $rp = $link->query($qp);
                if ($rp->num_rows > 0 ) {
                        ...
                        echo "<form method='post'>";
                            ...
                            echo "<div class='row' style='margin-top:2rem;width:auto;background-color:#EDEDED;border-radius:4px;overflow:hidden'>";
                                ...
                                echo "</div>";
                                    ...
                                    echo "<div class='show-comments' style='font-size:15px;margin:1rem;max-height:6rem;overflow:scroll;overflow-x: hidden;word-wrap: break-word;'>";
